...
int SurfaceRemeshing::RequestData(vtkInformation *vtkNotUsed(request), vtkInformationVector **inputVector, vtkInformationVector *outputVector)
{
    ...
    vtkClean->SetInputData(output);
    vtkClean->Update();
    output = vtkClean->GetOutput();
...
int SurfaceRemeshing::IsPointOnBoundary(vtkIdType pointId)
{
    vtkIdType* cells;
    #if (VTK_MAJOR_VERSION >= 9)
    vtkIdType ncells;
...
int SurfaceRemeshing::EdgeFlipConnectivityOptimizationIteration()
{
...
int SurfaceRemeshing::EdgeFlipIteration()
{
    int numberOfChanges = 0;
    int numberOfCells = this->Mesh->GetNumberOfCells();
    for (int i=0; i<numberOfCells; i++)
...
int SurfaceRemeshing::EdgeCollapseIteration()
{
    int numberOfChanges = 0;
    int numberOfCells = this->Mesh->GetNumberOfCells();
    for (int i=0; i<numberOfCells; i++)
...
int SurfaceRemeshing::EdgeSplitIteration()
{
    int numberOfChanges = 0;
    int numberOfCells = this->Mesh->GetNumberOfCells();
    for (int i=0; i<numberOfCells; i++)
...
int SurfaceRemeshing::TriangleSplitIteration()
{
    int numberOfChanges = 0;
    int numberOfCells = this->Mesh->GetNumberOfCells();
    for (int i=0; i<numberOfCells; i++)
...
int SurfaceRemeshing::PointRelocationIteration(bool projectToSurface)
{
...
int SurfaceRemeshing::IsElementExcluded(vtkIdType cellId)
{
...
int SurfaceRemeshing::IsPointOnEntityBoundary(vtkIdType pointId)
{
...
int SurfaceRemeshing::FindOneRingNeighbors(vtkIdType pointId, vtkSmartPointer<vtkIdList> neighborIds)
{
...
int SurfaceRemeshing::RelocatePoint(vtkIdType pointId, bool projectToSurface)
{
    vtkIdList* cellIds = vtkIdList::New();
    this->Mesh->GetPointCells(pointId,cellIds);
    ...
    else if (pointLocation == POINT_ON_BOUNDARY and !PreserveBoundaryEdges)
    {
        double targetPoint[3];
        targetPoint[0] = targetPoint[1] = targetPoint[2] = 0.0;
...
int SurfaceRemeshing::GetEdgeCellsAndOppositeEdge(vtkIdType pt1, vtkIdType pt2, vtkIdType& cell1, vtkIdType& cell2, vtkIdType& pt3, vtkIdType& pt4)
{
    cell1 = cell2 = -1;
    pt3 = pt4 = -1;
...
int SurfaceRemeshing::SplitTriangle(vtkIdType cellId)
{
    if (this->Mesh->GetCellType(cellId) != VTK_TRIANGLE)
        return NOT_TRIANGLES;
...
int SurfaceRemeshing::CollapseTriangle(vtkIdType cellId)
{
    (void) cellId;
...
int SurfaceRemeshing::SplitEdge(vtkIdType pt1, vtkIdType pt2)
{
    vtkIdType cell1, cell2, pt3, pt4;
    int success = SurfaceRemeshing::GetEdgeCellsAndOppositeEdge(pt1,pt2,cell1,cell2,pt3,pt4);
    ...
    else if (!this->PreserveBoundaryEdges)
    {
        double projectedNewPoint[3];
        vtkIdType cellId;
        int subId;
...
int SurfaceRemeshing::CollapseEdge(vtkIdType pt1, vtkIdType pt2)
{
    vtkIdType cell1, cell2, pt3, pt4;
    int success = SurfaceRemeshing::GetEdgeCellsAndOppositeEdge(pt1,pt2,cell1,cell2,pt3,pt4);
...
int SurfaceRemeshing::FlipEdge(vtkIdType pt1, vtkIdType pt2)
{
    vtkIdType cell1, cell2, pt3, pt4;
    int success = SurfaceRemeshing::GetEdgeCellsAndOppositeEdge(pt1,pt2,cell1,cell2,pt3,pt4);
    ...
    vtkIdType pt3b, pt4b;
    if (SurfaceRemeshing::GetEdgeCellsAndOppositeEdge(pt3,pt4,cell1,cell2,pt3b,pt4b) != SUCCESS)
    {
...
int SurfaceRemeshing::TestFlipEdgeValidity(vtkIdType pt1, vtkIdType pt2, vtkIdType cell1, vtkIdType cell2, vtkIdType pt3, vtkIdType pt4)
{
    (void) cell1;
    (void) cell2;
    vtkIdType tri[4][3];
...
int SurfaceRemeshing::TestConnectivityFlipEdge(vtkIdType pt1, vtkIdType pt2)
{
    vtkIdType cell1, cell2, pt3, pt4;
    int success = SurfaceRemeshing::GetEdgeCellsAndOppositeEdge(pt1,pt2,cell1,cell2,pt3,pt4);
...
int SurfaceRemeshing::TestDelaunayFlipEdge(vtkIdType pt1, vtkIdType pt2)
{
    vtkIdType cell1, cell2, pt3, pt4;
    int success = SurfaceRemeshing::GetEdgeCellsAndOppositeEdge(pt1,pt2,cell1,cell2,pt3,pt4);
...
double SurfaceRemeshing::ComputeTriangleTargetArea(vtkIdType cellId)
{
...
int SurfaceRemeshing::TestTriangleSplit(vtkIdType cellId)
{
    vtkIdType npts;
    #if (VTK_MAJOR_VERSION < 9)
    vtkIdType *pts;
...
int SurfaceRemeshing::TestAspectRatioCollapseEdge(vtkIdType cellId, vtkIdType& pt1, vtkIdType& pt2)
{
    pt1 = -1;
    pt2 = -1;
    ...
    if (frobeniusAspectRatio < this->AspectRatioThreshold and area > targetArea * this->MinAreaFactor and area < targetArea * this->MaxAreaFactor)
        return DO_NOTHING;
    ...
    #if (VTK_MAJOR_VERSION >= 9)
    vtkIdType ncells2, ncells3, ncells4;
    #else
    unsigned short ncells2, ncells3, ncells4;
    #endif
    ncells3 = ncells4 = 0;
    vtkIdType *cells;
    this->Mesh->GetPointCells(pt3,ncells3,cells);
...
int SurfaceRemeshing::TestAreaSplitEdge(vtkIdType cellId, vtkIdType& pt1, vtkIdType& pt2)
{
    pt1 = -1;
    pt2 = -1;
...
void SurfaceRemeshing::PrintSelf(ostream& os, vtkIndent indent)
{
